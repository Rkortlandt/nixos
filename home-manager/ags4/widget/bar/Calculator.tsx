...
import { Box, Popover } from "astal/gtk4/widget";
...
export function Calculator() {
    ...
    var calculationHistory = Variable([]);
                    ...
                    <entry
                        ...
                        onKeyPressEvent={(self, event) => {
                            ...
                            if (event.get_keyval()[1] === 65293) {
                                recentCalculation.set(calculate(self.get_buffer().text).result);
